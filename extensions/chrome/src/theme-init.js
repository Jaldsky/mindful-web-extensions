/**
 * Синхронная инициализация темы при загрузке страницы.
 * Использует класс ThemeInitializer для предотвращения мигания (flash).
 * 
 * Этот файл должен выполняться синхронно до загрузки основного JavaScript,
 * поэтому класс ThemeInitializer встроен здесь для самодостаточности.
 * Использует упрощенную версию логирования для синхронной работы.
 */
