...
const RU = {
    ...
    app: {
        ...
        onboarding: {
            title: '🧘 Mindful Web',
            subtitle: 'Отслеживайте время в сети и анализируйте цифровые привычки',
            feature1: 'Отслеживайте время на сайтах',
            feature2: 'Статистика посещений',
            feature3: 'Анализируйте графики и диаграммы',
            signInButton: 'Войти или зарегистрироваться',
            tryButton: 'Продолжить как гость',
        ...
        verify: {
            ...
            resendCodeLink: 'Отправить код снова',
            emailRequired: 'Укажите email для повторной отправки кода',
        ...
        resend: {
            ...
            emailLabel: 'Email',
            emailPlaceholder: 'Введите email',
            submitButton: 'Отправить код снова',
            backButton: 'Назад'
        },
    ...
    options: {
        ...
        notifications: {
            ...
            clearAllDataSuccess: 'Все данные очищены. Закройте попап (если открыт), затем откройте его снова — появится приветственное окно.',
            clearAllDataError: 'Не удалось очистить данные'
        }
