...
const RU = {
    ...
    logs: {
        ...
        eventQueue: {
            ...
            domainExceptionsUpdated: 'Исключения доменов обновлены',
        ...
        trackerStorage: {
            ...
            trackingEnabledLoaded: 'Статус отслеживания загружен',
        ...
        tracker: {
            ...
            initStart: 'Начало инициализации TrackerManager',
            userIdInitialized: 'User ID инициализирован',
            backendUrlLoaded: 'Backend URL загружен',
            domainExceptionsLoaded: 'Исключения доменов загружены',
            eventQueueRestored: 'Очередь событий восстановлена',
            trackingStatusRestored: 'Статус отслеживания восстановлен',
            messageHandlersConfigured: 'Обработчики сообщений настроены',
            ...
            batchProcessorStarted: 'Batch processor запущен',
            onlineMonitoringConfigured: 'Мониторинг онлайн/офлайн настроен',
            lifecycleHandlersConfigured: 'Lifecycle handlers настроены',
            initSuccess: 'TrackerManager инициализирован успешно',
