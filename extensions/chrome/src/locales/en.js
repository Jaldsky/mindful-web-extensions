...
const EN = {
    ...
    logs: {
        ...
        eventQueue: {
            ...
            domainExceptionsUpdated: 'Domain exceptions updated',
            ...
            batchProcessorStarted: 'Batch processor started',
            batchProcessorStopped: 'Batch processor stopped',
            queueEmpty: 'Queue is empty, nothing to process',
            ...
            batchSentSuccess: 'Batch sent successfully',
        ...
        tracker: {
            ...
            initStart: 'Starting TrackerManager initialization',
            userIdInitialized: 'User ID initialized',
            backendUrlLoaded: 'Backend URL loaded',
            domainExceptionsLoaded: 'Domain exceptions loaded',
            eventQueueRestored: 'Event queue restored',
            trackingStatusRestored: 'Tracking status restored',
            messageHandlersConfigured: 'Message handlers configured',
            tabTrackingInitialized: 'Tab tracking initialized',
            trackingDisabledNotStarted: 'Tracking disabled, tab tracking not started',
            batchProcessorStarted: 'Batch processor started',
            onlineMonitoringConfigured: 'Online/offline monitoring configured',
            lifecycleHandlersConfigured: 'Lifecycle handlers configured',
            initSuccess: 'TrackerManager initialized successfully',
